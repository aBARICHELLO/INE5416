...
solucao(ListaSolucao) :-
    ListaSolucao=[navio(Nacionalidade1, Saida1, Carregamento1, Chamine1, Destino1), navio(Nacionalidade2, Saida2, Carregamento2, Chamine2, Destino2), navio(Nacionalidade3, Saida3, Carregamento3, Chamine3, Destino3), navio(Nacionalidade4, Saida4, Carregamento4, Chamine4, Destino4), navio(Nacionalidade5, Saida5, Carregamento5, Chamine5, Destino5)],
